 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Johnathan Chin");
		  toPrint += p1.toString("jchin32");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Hoa V Luu");
		  toPrint += p2.toString("hluu8");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Matthew Orubina");
		  toPrint += p3.toString("morubina3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Jonathan Najjar");
                  toPrint += p4.toString("jnajjar6");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Yumin Jeong");
                  toPrint += p5.toString("yjeong73");
